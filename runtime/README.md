...
This folder is the staging backend foundation for the 100-agent office.
...
## Database
Run `schema.sql` against a **staging D1** database. Seed the 100-agent registry from `../data/agents100.json`.
